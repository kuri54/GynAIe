...
from gynaie.util import get_image_path_to_df, get_model_id, get_label
from gynaie.util import print_logo, save_df, get_platform
...
parser.add_argument('--model_name', type= str, default='GynAIe-preview-clip-vit-large-patch14-336')
...
def main():
    ...
    log_message(f'Running on {platform_info}', 'notice')

    input_df, case_df, case_name = get_image_path_to_df(args.input_dir)
    model_id = get_model_id(args.model_name, platform_info)
